...
cp -r $HOME/projects/packer-boxes/shared/home-configs/{.vimrc,.tmux.conf,.bash_profile,.bashrc,.inputrc,.gitconfig,.gitignore,.vim/,global_extra_conf.py,start-intellij.sh} ~/ 
exec $SHELL
